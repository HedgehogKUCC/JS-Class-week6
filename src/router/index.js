...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'coupons',
        component: () => import('../views/back/components/Coupons.vue'),
      },
      {
        path: 'orderlist',
        component: () => import('../views/back/components/OrderList.vue'),
      },
      {
        path: 'imagelist',
        component: () => import('../views/back/components/ImageList.vue'),
      },
    ],
  },
  {
